...
addPropertyControls(Select, {
  autoWidth: { title: "AutoWidth", type: ControlType.Boolean },
  displayEmpty: { title: "DisplayEmpty", type: ControlType.Boolean },
  IconComponent: {
    title: "IconComponent",
    options: [
      "symbol",
  ...
  native: { title: "Native", type: ControlType.Boolean },
